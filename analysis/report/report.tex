...
\renewcommand{\stamptime}{2026-08-15 16:35 PDT}
\renewcommand{\stampversion}{\detokenize{7dbf322}}
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{booktabs}
...
model of\textsuperscript{\citeproc{ref-lairdRandomEffectsModels1982}{2}}, which provides maximum
...
\textsuperscript{\citeproc{ref-mallinckrodtEfficacyDuloxetine2004}{14}} provided an influential
...
In the Alzheimer's disease trial literature,\textsuperscript{\citeproc{ref-ardMixedModelRepeated2011}{15}} compared MMRM with slope models
...
disease-modifying effects.\textsuperscript{\citeproc{ref-ardSimulationStudyComparing2015}{16}}
...
\item
  \textbf{Estimands.} The treatment effect on the slope,
...
(108 scenario-method combinations), the
...
0\%
missing,
MAR mechanism. Power ranged from
0.07 to
0.94 depending on
...
particularly instructive case study.\textsuperscript{\citeproc{ref-ardMixedModelRepeated2011}{15}} and\textsuperscript{\citeproc{ref-ardSimulationStudyComparing2015}{16}}
...
\textsuperscript{\citeproc{ref-liuMixedModelsCovariateInteractions2021}{18}} highlighted
...
\item
  ...
  measures approach with Bayesian sample size determination\textsuperscript{\citeproc{ref-baghfalakiBayesianSampleSize2019}{19}} and posterior inference
...
\item
  ...
  \texttt{summarize\_results()} function in \texttt{sim\_study.R} returns
