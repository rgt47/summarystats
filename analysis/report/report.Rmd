...
# >= 2500. We use 1000 as a pragmatic compromise; for publication runs,
# raise to 2000+ and re-knit (cache will re-build).
n_reps <- 1000
...
- Simulation chunks in the report are `eval=FALSE` — the rendered report describes a simulation that never ran.
- No `set.seed()` call anywhere in `sim_study.R`.
- No Monte Carlo SE machinery; placeholder text remains in place of results.
